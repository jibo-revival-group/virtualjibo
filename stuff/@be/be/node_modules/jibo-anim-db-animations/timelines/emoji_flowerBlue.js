(function (PIXI, lib) {
    ...
    var Graphic1 = MovieClip.extend(function (mode) {
        ...
        var instance1 = new Sprite(fromFrame("flower-white-pot1"))
            .setTransform(-122.95, -79.75);
        this.addTimedChild(instance1);
    });

    var Graphic2 = MovieClip.extend(function (mode) {
        MovieClip.call(this, { mode: mode, duration: 29, loop: false });
        var instance1 = new Sprite(fromFrame("flower-blue-petal1"))
            .setTransform(-97.95, -109.15);
        this.addTimedChild(instance1);
    });

    var Graphic3 = MovieClip.extend(function (mode) {
        MovieClip.call(this, { mode: mode, duration: 29, loop: false });
        var instance1 = new Sprite(fromFrame("flower-blue-petal2"))
            .setTransform(-98.15, -109.15);
        this.addTimedChild(instance1);
    });

    var Graphic4 = MovieClip.extend(function (mode) {
        MovieClip.call(this, { mode: mode, duration: 29, loop: false });
        var instance1 = new Sprite(fromFrame("flower-blue-petal3"))
            .setTransform(-58.15, -135.8);
        this.addTimedChild(instance1);
    });

    var Graphic5 = MovieClip.extend(function (mode) {
        MovieClip.call(this, { mode: mode, duration: 29, loop: false });
        var instance1 = new Sprite(fromFrame("flower-blue-stem1"))
            .setTransform(-10, -81.65);
        this.addTimedChild(instance1);
    });

    var Graphic6 = MovieClip.extend(function (mode) {
        MovieClip.call(this, { mode: mode, duration: 29, loop: false });
        var instance1 = new Sprite(fromFrame("flower-blue-leaf1"))
            .setTransform(-44.9, -35.65);
        this.addTimedChild(instance1);
    });
    ...
    var Graphic8 = MovieClip.extend(function (mode) {
        ...
        this.addTimedChild(instance7, 4, 29, {
                "4": {
                    x: 29.05,
                    y: 174.9,
                    sx: 1,
    ...
    var Graphic31 = MovieClip.extend(function (mode) {
        MovieClip.call(this, { mode: mode, duration: 16, loop: false });
        var instance11 = new Graphic30(MovieClip.SYNCHED)
            .setTransform(-1.45, -226.15, 0.735, 0.735);
        var instance10 = new Graphic28(MovieClip.SYNCHED)
            .setTransform(132.25, -204.9, 0.735, 0.735, 0.61);
        var instance9 = new Graphic26(MovieClip.SYNCHED)
            .setTransform(-139.7, -202.3, 0.735, 0.735, 0, 0.636, 2.506);
        var instance8 = new Graphic24(MovieClip.SYNCHED)
            .setTransform(-151.3, 197.9, 0.735, 0.735, -2.575);
        var instance7 = new Graphic22(MovieClip.SYNCHED)
            .setTransform(155.15, 192.95, 0.735, 0.735, 0, 3.781, -0.64);
        var instance6 = new Graphic20(MovieClip.SYNCHED)
            .setTransform(245.15, -10, 0.735, 0.735, 0, 4.712, 1.571);
        var instance5 = new Graphic18(MovieClip.SYNCHED)
            .setTransform(214.15, 109.95, 0.735, 0.735, 0, 4.146, 2.137);
        var instance4 = new Graphic16(MovieClip.SYNCHED)
            .setTransform(215.95, -126.7, 0.735, 0.735, 0, -1.004, -2.137);
        var instance3 = new Graphic14(MovieClip.SYNCHED)
            .setTransform(-253.7, -10, 0.735, 0.735, 0, 1.571, 1.571);
        var instance2 = new Graphic12(MovieClip.SYNCHED)
            .setTransform(-226.75, 113.95, 0.735, 0.735, 0, 2.137, 1.004);
        var instance1 = new Graphic10(MovieClip.SYNCHED)
            .setTransform(-222.5, -123.7, 0.735, 0.735, -1.004);
    ...
    lib.emoji_flowerBlue = MovieClip.extend(function () {
        MovieClip.call(this, {
            duration: 39,
            framerate: 30,
            loop: false
        ...
        this.addTimedChild(instance2, 10, 16, {
                "10": {
                    x: 639.1,
                    y: 219.4,
                    sx: 0.703,
    ...
    lib.emoji_flowerBlue.assets = {
        "emoji_flowerBlue_atlas_1": "images/emoji_flowerBlue_atlas_1.json"
    };
})(PIXI, lib = lib || {});
var lib;
if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
        stage: lib.emoji_flowerBlue,
        background: 0x0,
        width: 1280,
        height: 720,
        framerate: 30,
