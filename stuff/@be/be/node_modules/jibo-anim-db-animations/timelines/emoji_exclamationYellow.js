(function (PIXI, lib) {
    ...
    var Graphic1 = MovieClip.extend(function (mode) {
        ...
        var instance1 = new Sprite(fromFrame("exclamationyellow-top1"))
            .setTransform(-62.65, -195.45);
        this.addTimedChild(instance1);
    });

    var Graphic2 = MovieClip.extend(function (mode) {
        MovieClip.call(this, { mode: mode, duration: 31, loop: false });
        var instance1 = new Sprite(fromFrame("exclamationyellow-dot1"))
            .setTransform(-46.45, -46.35);
        this.addTimedChild(instance1);
    });
    ...
    var Graphic4 = MovieClip.extend(function (mode) {
        ...
        var instance1 = new Sprite(fromFrame("exyellow-line1"))
            .setTransform(-2.6, -4.85);
        this.addTimedChild(instance1);
    });
    ...
    lib.emoji_exclamationYellow = MovieClip.extend(function () {
        MovieClip.call(this, {
            duration: 32,
            framerate: 30,
            loop: false
        ...
        this.addTimedChild(instance7, 0, 14, {
                "0": {
                    x: 775.4,
                    y: 214,
                    sx: 0.972,
    ...
    lib.emoji_exclamationYellow.assets = {
        "emoji_exclamationYellow_atlas_1": "images/emoji_exclamationYellow_atlas_1.json"
    };
})(PIXI, lib = lib || {});
var lib;
if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
        stage: lib.emoji_exclamationYellow,
        background: 0x0,
        width: 1280,
        height: 720,
        framerate: 30,
