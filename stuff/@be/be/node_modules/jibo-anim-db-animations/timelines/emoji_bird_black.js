(function (PIXI, lib) {
    ...
    var Graphic1 = MovieClip.extend(function (mode) {
        ...
        var instance1 = new Sprite(fromFrame("eye1"));
        var instance2 = new Sprite(fromFrame("eye2"));
        var instance3 = new Sprite(fromFrame("eye1"))
            .setTransform(-11, -11.05);
        this.addTimedChild(instance1, 0, 14, {
            ...
            .addTimedChild(instance2, 14, 2, {
                "14": {
                    x: -11.55,
                    y: -2.1
                }
            })
            .addTimedChild(instance3, 16, 14);
    });
    ...
    var Graphic3 = MovieClip.extend(function (mode) {
        ...
        var instance1 = new Sprite(fromFrame("wing1"))
            .setTransform(-124.95, -71);
        this.addTimedChild(instance1);
    });
    ...
    var Graphic5 = MovieClip.extend(function (mode) {
        ...
        var instance1 = new Graphics()
            .drawCommands(shapes.emoji_bird_black[0]);
        this.addTimedChild(instance1);
    });
    ...
    var Graphic7 = MovieClip.extend(function (mode) {
        ...
        var instance1 = new Sprite(fromFrame("bird-body2"))
            .setTransform(-149.15, -137.85);
        this.addTimedChild(instance1);
    });

    var Graphic8 = MovieClip.extend(function (mode) {
        MovieClip.call(this, { mode: mode, duration: 46, loop: false });
        var instance1 = new Sprite(fromFrame("bird-body1"))
            .setTransform(-114, -18.6);
        this.addTimedChild(instance1);
    });
    ...
    var Graphic9 = MovieClip.extend(function (mode) {
        ...
        var instance4 = new lib.Graphic6();
        this.addTimedChild(instance1)
    ...
    var Graphic10 = MovieClip.extend(function (mode) {
        MovieClip.call(this, { mode: mode, duration: 27, loop: false });
        var instance1 = new Sprite(fromFrame("leg11"))
            .setTransform(-21.5, -80);
        this.addTimedChild(instance1);
    });

    var Graphic11 = MovieClip.extend(function (mode) {
        MovieClip.call(this, { mode: mode, duration: 28, loop: false });
        var instance1 = new Sprite(fromFrame("leg21"))
            .setTransform(-22, -36);
        this.addTimedChild(instance1);
    });
    ...
    var Graphic12 = MovieClip.extend(function (mode) {
        ...
        var instance1 = new Sprite(fromFrame("beak1"))
            .setTransform(-42, -28.4);
        this.addTimedChild(instance1);
    });
    ...
    var Graphic13 = MovieClip.extend(function (mode) {
        ...
        var instance8 = new Graphic2(MovieClip.SYNCHED);
        this.addTimedChild(instance6, 11, 29, {
                "11": {
                    x: 131.6,
                    y: -81.5,
                    sx: 0.265,
    ...
    lib.emoji_bird_black = MovieClip.extend(function () {
        MovieClip.call(this, {
            duration: 47,
            framerate: 30,
            loop: false
        ...
        this.addTimedChild(instance8, 15, 18, {
                "15": {
                    x: 846.05,
                    y: 445.45,
                    ky: 3.142,
            ...
            .addTimedChild(instance5, 12, 21, {
                "12": {
                    x: 497.85,
                    y: 247.55
                }
            })
            .addTimedChild(instance4, 12, 21, {
                "12": {
                    x: 864.95,
                    y: 202.4,
                    sx: 1.489,
    ...
    lib.emoji_bird_black.assets = {
        "emoji_bird_black": "images/emoji_bird_black.shapes.json",
        "emoji_bird_black_atlas_1": "images/emoji_bird_black_atlas_1.json",
        "emoji_bird_black_atlas_2": "images/emoji_bird_black_atlas_2.json",
        "emoji_bird_black_atlas_3": "images/emoji_bird_black_atlas_3.json"
    };
})(PIXI, lib = lib || {});
var lib;
if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
        stage: lib.emoji_bird_black,
        background: 0x0,
        width: 1280,
        height: 720,
        framerate: 30,
