(function (PIXI, lib) {
    ...
    var Graphic1 = MovieClip.extend(function (mode) {
        ...
        var instance1 = new Sprite(fromFrame("exclamationred-top1"))
            .setTransform(-62.4, -195.45);
        this.addTimedChild(instance1);
    });

    var Graphic2 = MovieClip.extend(function (mode) {
        MovieClip.call(this, { mode: mode, duration: 31, loop: false });
        var instance1 = new Sprite(fromFrame("exclamationred-dot1"))
            .setTransform(-46.95, -46.9);
        this.addTimedChild(instance1);
    });
    ...
    var Graphic4 = MovieClip.extend(function (mode) {
        ...
        var instance1 = new Sprite(fromFrame("exred-line1"))
    ...
    lib.emoji_exclamationRed = MovieClip.extend(function () {
        MovieClip.call(this, {
            duration: 32,
            framerate: 30,
            loop: false
    ...
    lib.emoji_exclamationRed.assets = {
        "emoji_exclamationRed_atlas_1": "images/emoji_exclamationRed_atlas_1.json"
    };
})(PIXI, lib = lib || {});
var lib;
if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
        stage: lib.emoji_exclamationRed,
        background: 0x0,
        width: 1280,
        height: 720,
        framerate: 30,
