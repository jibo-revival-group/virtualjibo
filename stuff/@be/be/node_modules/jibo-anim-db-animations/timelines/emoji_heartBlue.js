(function (PIXI, lib) {
    ...
    var Graphic1 = MovieClip.extend(function (mode) {
        MovieClip.call(this, { mode: mode, duration: 63, loop: false });
        var instance1 = new Sprite(fromFrame("heart-shine-blue1"))
    ...
    var Graphic2 = MovieClip.extend(function (mode) {
        ...
        var instance1 = new Sprite(fromFrame("heart-shape-blue1"))
    ...
    var Graphic3 = MovieClip.extend(function (mode) {
        ...
        var instance1 = new Sprite(fromFrame("smallheart-blue1"))
            .setTransform(-58.45, -48.25, 1.446, 1.446);
        this.addTimedChild(instance1);
    });
    ...
    var Graphic5 = MovieClip.extend(function (mode) {
        ...
        var instance1 = new Sprite(fromFrame("smallheart-blue2"))
            .setTransform(-41.65, -34.25, 1.446, 1.446);
        this.addTimedChild(instance1);
    });
    ...
    var Graphic7 = MovieClip.extend(function (mode) {
        ...
        this.addTimedChild(instance4, 18, 49, {
                "18": {
                    x: -351,
                    y: 177.15
                }
            })
            .addTimedChild(instance3, 15, 52, {
                "15": {
                    x: 382.5,
                    y: -318.4
                }
    ...
    var Graphic8 = MovieClip.extend(function (mode) {
        ...
        var instance1 = new Sprite(fromFrame("line-blue1"))
    ...
    var Graphic36 = MovieClip.extend(function (mode) {
        ...
        var instance13 = new Graphic33(MovieClip.SYNCHED)
            .setTransform(357.7, 572.4, 0.884, 0.884, 0, 3.833, -0.692);
        var instance12 = new Graphic31(MovieClip.SYNCHED)
            .setTransform(703.85, 71.6, 0.884, 0.884, 0, 4.465, 1.818);
        var instance11 = new Graphic29(MovieClip.SYNCHED)
            .setTransform(576.25, 342.25, 0.884, 0.884, 0, 4.046, 2.237);
        var instance10 = new Graphic27(MovieClip.SYNCHED)
            .setTransform(747.5, -266.4, 0.884, 0.884, 0, -1.351, -1.79);
        var instance9 = new Graphic25(MovieClip.SYNCHED)
        ...
        var instance6 = new Graphic19(MovieClip.SYNCHED)
        ...
        var instance2 = new Graphic11(MovieClip.SYNCHED)
    ...
    lib.emoji_heartBlue = MovieClip.extend(function () {
        MovieClip.call(this, {
            duration: 69,
            framerate: 30,
            loop: false
        });
        var instance2 = new Graphic36(MovieClip.SYNCHED);
        var instance1 = new Graphic7(MovieClip.SYNCHED);
        this.addTimedChild(instance2, 4, 19, {
                "4": {
                    x: 640,
                    y: 362.7,
                    sx: 0.423,
    ...
    lib.emoji_heartBlue.assets = {
        "emoji_heartBlue_atlas_1": "images/emoji_heartBlue_atlas_1.json"
    };
})(PIXI, lib = lib || {});
var lib;
if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
        stage: lib.emoji_heartBlue,
        background: 0x0,
        width: 1280,
        height: 720,
        framerate: 30,
