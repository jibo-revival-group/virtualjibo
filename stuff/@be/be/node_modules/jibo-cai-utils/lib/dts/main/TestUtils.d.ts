...
export declare class TestUtils {
     ...
     */
    static clearTests(namespace?: string): void;
    /**
     * Turn on/off testing
     * @param {boolean} enable
     */
    static enableTesting(enable: boolean): void;
    /**
     * Returns namespace, if undefined then returns default namespace
     * @param namespace
     * @returns {any}
     */
    static getNamespace(namespace?: string): NameSpace;
    /**
     ...
     */
    static setTestDate(date: Date, id: string, namespace?: string): void;
    /**
     ...
     * @returns {Date}
     */
    static getDate(id?: string, namespace?: string): Date;
    /**
     ...
     * @param {string} [namespace='']
     */
    static setTestRandom(randomNum: number, id: string, namespace?: string): void;
    /**
     ...
     * @returns {number}
     */
    static getRandom(id?: string, namespace?: string): number;
}
