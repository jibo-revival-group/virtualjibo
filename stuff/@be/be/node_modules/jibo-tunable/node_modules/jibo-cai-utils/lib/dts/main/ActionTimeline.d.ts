import { TimelineElement } from './TimeUtils';
export declare enum ActionTimelineState {
    DISPATCHING = 0,
    NOT_DISPATCHING = 1,
    CANCELLED = 2,
    FAST_FORWARD = 3,
...
export declare class ActionTimeline {
     ...
     */
    dispatchTimeline(timeline: TimelineElement[]): Promise<any>;
    _dispatchTimeline(el: TimelineElement, startTime: number[]): Promise<any>;
    /**
     ...
     * @returns {Promise<void>}
     */
    _wait(timeMs: number): Promise<any>;
    /**
