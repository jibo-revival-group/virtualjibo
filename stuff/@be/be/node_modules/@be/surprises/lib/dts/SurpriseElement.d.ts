...
export declare abstract class SurpriseElement extends BeSkill {
    /**
     ...
     * @type {boolean}
     */
    readonly isElementOfSurprise: boolean;
    /**
     ...
     */
    abstract getContextualPriority(context: LaunchContext): Promise<number>;
    /**
