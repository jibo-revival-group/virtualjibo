...
[![Build Status](https://jenkins2.jibo.com/buildStatus/icon?job=first-contact/master)](https://jenkins2.jibo.com/view/Skills/job/first-contact/job/master/)

Handles first awakening and quick introductions.
...
From BE root directory on your computer, run `yarn first:robot|local:enable|disable`
