...
# This creates a temp directory and npm installs the specified ssm version
echo "\nDownloading (npm installing) the skills-service-manager@$1 package...\n"
rm -rf tmp
mkdir tmp
cd tmp
npm init --yes --quiet
npm install skills-service-manager@$1

cd tmp;
cd node_modules/skills-service-manager
