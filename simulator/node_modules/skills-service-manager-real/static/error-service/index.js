...
},{"./adapters/http":2,"./adapters/xhr":2,"./helpers/normalizeHeaderName":22,"./utils":25}],15:[function(require,module,exports){
'use strict';
...
},{"./emptyFunction":30}],40:[function(require,module,exports){
/*!
...
},{"./lib/ReactPropTypesSecret":43,"fbjs/lib/invariant":35,"fbjs/lib/warning":39}],43:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/ExecutionEnvironment":26,"fbjs/lib/camelizeStyleName":28,"fbjs/lib/containsNode":29,"fbjs/lib/emptyFunction":30,"fbjs/lib/emptyObject":31,"fbjs/lib/getActiveElement":32,"fbjs/lib/hyphenateStyleName":34,"fbjs/lib/invariant":35,"fbjs/lib/shallowEqual":38,"fbjs/lib/warning":39,"object-assign":41,"prop-types/checkPropTypes":42,"react":49}],45:[function(require,module,exports){
/** @license React v16.3.2
...
},{"fbjs/lib/ExecutionEnvironment":26,"fbjs/lib/containsNode":29,"fbjs/lib/emptyFunction":30,"fbjs/lib/emptyObject":31,"fbjs/lib/getActiveElement":32,"fbjs/lib/invariant":35,"fbjs/lib/shallowEqual":38,"object-assign":41,"react":49}],46:[function(require,module,exports){
'use strict';
...
},{"fbjs/lib/emptyFunction":30,"fbjs/lib/emptyObject":31,"fbjs/lib/invariant":35,"fbjs/lib/warning":39,"object-assign":41,"prop-types/checkPropTypes":42}],48:[function(require,module,exports){
/** @license React v16.3.2
...
},{"fbjs/lib/emptyFunction":30,"fbjs/lib/emptyObject":31,"fbjs/lib/invariant":35,"object-assign":41}],49:[function(require,module,exports){
'use strict';
...
},{"./cjs/react.development.js":47,"./cjs/react.production.min.js":48}],50:[function(require,module,exports){
"use strict";
...
class ErrorServiceClient {
    ...
    getErrorCodeData() {
        return __awaiter(this, void 0, void 0, function* () {
            const errorCodeDataUrl = `${this.origin}/errorCodeData`;
            return axios_1.default.post(errorCodeDataUrl).then(res => ErrorServiceClient._sortByKeys(res.data.errorList), () => {
                throw new Error('cannot get error code data');
            });
        });
    }
    static _sortByKeys(objects) {
        const keys = Object.keys(objects);
        const reducer = (sorted, key) => {
            return Object.assign({}, sorted, { [key]: objects[key] });
        };
        return keys.sort().reduce(reducer, {});
    }
    getCurrentErrorServiceError() {
        return __awaiter(this, void 0, void 0, function* () {
            const getCurrentErrorIdUrl = `${this.origin}/getCurrentErrorId`;
            return axios_1.default.post(getCurrentErrorIdUrl).then(res => res.data.currentErrorId, () => {
                throw new Error('cannot get current error id data');
            });
        });
    }
    getErrorServiceContents() {
        return __awaiter(this, void 0, void 0, function* () {
            const getContentsUrl = `${this.origin}/getContents`;
            return axios_1.default.post(getContentsUrl).then(res => {
                return {
                    priorityQueueErrors: JSON.parse(res.data.priorityQueueErrors),
                    reschedulerErrors: JSON.parse(res.data.reschedulerErrors),
                };
            }, () => {
                throw new Error('cannot get priority queue data');
            });
        });
    }
    sendMockCodes(activeErrors) {
        const codes = activeErrors.map(errorCode => errorCode._id);
        const mockCodesUrl = `${this.origin}/mockErrorCodes`;
        axios_1.default.post(mockCodesUrl, { codes, enabled: codes.length > 0 });
    }
    disableSkillSwitch(event) {
        const disabled = event.target.checked;
        const disableSkillSwitchingUrl = `${this.origin}/disableSkillSwitching`;
        axios_1.default.post(disableSkillSwitchingUrl, { disabled });
    }
}
exports.default = ErrorServiceClient;

},{"axios":1}],51:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
class ErrorService extends React.Component {
    constructor(props) {
        super(props);
        this._moveRight = () => {
            const selectedErrors = this._errorCodesForSelectedOptions(document.getElementById('left'));
            const activeErrors = [...this.state.activeErrors, ...selectedErrors].sort((a, b) => a._id.localeCompare(b._id));
            const inactiveErrors = this.state.inactiveErrors.filter(code => !selectedErrors.includes(code));
            this.setState({
                activeErrors,
                inactiveErrors,
                selectedErrors,
            });
            this._client.sendMockCodes(activeErrors);
        };
        this._moveLeft = () => {
            const selectedErrors = this._errorCodesForSelectedOptions(document.getElementById('right'));
            const inactiveErrors = [...this.state.inactiveErrors, ...selectedErrors].sort((a, b) => a._id.localeCompare(b._id));
            const activeErrors = this.state.activeErrors.filter(code => !selectedErrors.includes(code));
            this.setState({
                activeErrors,
                inactiveErrors,
                selectedErrors,
        ...
        this._moveAllRight = () => {
            const activeErrors = Object.keys(this.state.errorMap)
                .map(key => this.state.errorMap[key]);
        ...
        this._moveAllLeft = () => {
            const activeErrors = [];
            const inactiveErrors = Object.keys(this.state.errorMap)
                .map(key => this.state.errorMap[key]);
            this.setState({
                activeErrors,
                inactiveErrors,
        ...
        this._updateErrorServiceInfo = () => __awaiter(this, void 0, void 0, function* () {
            this.setState(Object.assign({ currentErrorServiceErrorId: yield this._client.getCurrentErrorServiceError() }, (yield this._client.getErrorServiceContents())));
        });
        this._selectError = () => {
            const leftCodes = this._errorCodesForSelectedOptions(document.getElementById('left'));
            const rightCodes = this._errorCodesForSelectedOptions(document.getElementById('right'));
            const allCodes = [...leftCodes, ...rightCodes];
            const selectedErrors = allCodes.sort((a, b) => a._id.localeCompare(b._id));
            this.setState({ selectedErrors });
        };
        this._client = new client_1.default(location.origin);
        this._init();
    }
    _init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const errorMap = yield this._client.getErrorCodeData();
            const inactiveErrors = Object.keys(errorMap).map(id => errorMap[id]);
            this.setState({ errorMap, inactiveErrors });
        });
    }
    _errorCodesForSelectedOptions(node) {
        return Array.from(node.children)
            .filter(node => node.selected)
            .map(node => this.state.errorMap[node.id]);
    }
    render() {
        return React.createElement("div", null,
            React.createElement("h1", null, "Error Service Debug Page"),
            React.createElement("label", null,
                React.createElement("input", { type: "checkbox", onChange: event => this._client.disableSkillSwitch(event) }),
                "Disable error service skill switch",
                React.createElement("br", null),
                React.createElement("input", { type: "button", onClick: this._updateErrorServiceInfo, value: "Refresh" })),
            React.createElement("table", null,
                React.createElement("tbody", null,
                    React.createElement("tr", null,
                        React.createElement("td", null,
                            React.createElement("text", null, "Error List"),
                            React.createElement("br", null),
                            React.createElement("select", { multiple: true, id: "left", style: { height: 500, width: 300 }, onChange: this._selectError }, this.state.inactiveErrors.map(code => React.createElement("option", { id: code._id, key: code._id, selected: this.state.selectedErrors.includes(code) }, code._id)))),
                        React.createElement("td", null,
                            React.createElement("input", { type: "button", value: "<", onClick: this._moveLeft }),
                            React.createElement("input", { type: "button", value: "<<", onClick: this._moveAllLeft }),
                            React.createElement("input", { type: "button", value: ">>", onClick: this._moveAllRight }),
                            React.createElement("input", { type: "button", value: ">", onClick: this._moveRight })),
                        React.createElement("td", null,
                            React.createElement("text", null, "Active Errors"),
                            React.createElement("br", null),
                            React.createElement("select", { multiple: true, id: "right", style: { height: 500, width: 300 }, onChange: this._selectError }, this.state.activeErrors.map(code => React.createElement("option", { id: code._id, key: code._id, selected: this.state.selectedErrors.includes(code) }, code._id))))))),
            React.createElement("div", { id: "current-error" },
                React.createElement("text", null,
                    React.createElement("h3", null, "Current Error Service Error:"),
                    this.state.currentErrorServiceErrorId)),
            React.createElement("div", { id: "priority-queue-errors" },
                React.createElement("text", null,
                    React.createElement("h3", null, "Current Priority Queue Errors:"),
                    this.state.priorityQueueErrors.map(code => React.createElement("pre", { id: code._id, key: code._id }, JSON.stringify(code, null, 4))))),
            React.createElement("div", { id: "rescheduler-errors" },
                React.createElement("text", null,
                    React.createElement("h3", null, "Rescheduler Errors:"),
                    this.state.reschedulerErrors.map(code => React.createElement("pre", { id: code._id, key: code._id }, JSON.stringify(code, null, 4))))),
            React.createElement("div", { id: "error-info" },
                React.createElement("text", null,
                    React.createElement("h2", null, "Error Info")),
                this.state.selectedErrors.map(code => React.createElement("pre", { id: code._id, key: code._id }, JSON.stringify(code, null, 4)))));
    }
}
document.addEventListener('DOMContentLoaded', () => {
    ReactDOM.render(React.createElement(ErrorService, null), document.getElementById('error-service'));
});

},{"./client":50,"react":49,"react-dom":46}]},{},[51])(51)
});
